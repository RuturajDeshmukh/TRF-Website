               ...
               <nav class="navbar navbar-expand-lg navbar-light">
                  ...
                  <div class="collapse navbar-collapse main-menu-item" id="navbarNav">
                     <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                           <a class="nav-link headeranchors"  href="search4.php" style="color: red;">Project Tables</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item headeranchors" href="quiz_mainpage1.php" style="background:none !important;">Quizes</a>
                              <a class="dropdown-item headeranchors" href="leaderboard3.php" style="background:none !important;">Leaderboard</a>
                           </div>
                        </li>
